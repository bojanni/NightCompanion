...
- Prompt Library now includes a `Media` view that embeds the former Gallery workflow, and image browsing from the dashboard now opens inside Prompt Library instead of a separate Gallery screen.
